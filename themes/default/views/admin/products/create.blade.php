                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted">{{ __('Configure how this product scales when customers choose additional slots or memory.') }}</p>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('slot_increment_price', isset($product) ? Currency::formatForForm($product->slot_increment_price) : null) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('memory_increment_price', isset($product) ? Currency::formatForForm($product->memory_increment_price) : null) }}"
