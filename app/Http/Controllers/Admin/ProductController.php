...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'player_slots' => 'nullable|numeric|max:1000000|min:0',
            'slot_increment_step' => 'nullable|numeric|max:1000000|min:0',
            'slot_increment_price' => 'nullable|numeric|max:1000000|min:0',
            'slot_increment_max_steps' => 'nullable|numeric|max:1000000|min:0',
